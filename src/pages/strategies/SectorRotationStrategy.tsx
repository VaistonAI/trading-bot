...
import { FaChartLine, FaDollarSign, FaSync } from 'react-icons/fa';
...
export const SectorRotationStrategy: React.FC = () => {
    ...
    const STRATEGY_ID = 'sector-rotation';
        ...
        try {
            ...
            if (!existingStrategy) {
                const newStrategyData: Omit<Strategy, 'id'> = {
                    ...
                    description: 'Rotación sectorial. Aprovecha ciclos económicos invirtiendo en sectores con mejor performance relativa según indicadores macroeconómicos.',
                    isActive: true,
    ...
    return (
        <MainLayout>
            <div className="space-y-6">
                <div>
                    <h1 className="text-3xl font-bold text-text-primary">Sector Rotation</h1>
                ...
                <div className="bg-white rounded-xl shadow-md border border-border overflow-hidden">
                    ...
                    <div className="p-6">
                        {activeTab === 'overview' && (
                            <div className="space-y-6">
                                <StrategyChart symbol="XLK" interval="D" height={500} />
                                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                    <div>
                                        <h3 className="text-lg font-semibold text-text-primary mb-4">Ciclo Económico</h3>
                                        <div className="space-y-3">
                                            <div className="p-4 bg-bg-primary rounded-lg">
                                                <p className="text-sm text-text-secondary">Expansión Temprana</p>
                                                <p className="text-sm font-bold text-text-primary">Financiero, Tecnología</p>
                                            </div>
                                            <div className="p-4 bg-bg-primary rounded-lg">
                                                <p className="text-sm text-text-secondary">Expansión Tardía</p>
                                                <p className="text-sm font-bold text-text-primary">Energía, Materiales</p>
                                            </div>
                                            <div className="p-4 bg-bg-primary rounded-lg">
                                                <p className="text-sm text-text-secondary">Recesión</p>
                                                <p className="text-sm font-bold text-text-primary">Consumo Básico, Salud</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div>
                                        <h3 className="text-lg font-semibold text-text-primary mb-4">Indicadores Macro</h3>
                                        <div className="space-y-3">
                                            <div className="p-4 bg-success/10 rounded-lg border border-success/20">
                                                <p className="text-sm font-semibold text-success mb-2">✓ Señales</p>
                                                <ul className="text-xs text-text-secondary space-y-1">
                                                    <li>• Performance relativa de sectores</li>
                                            ...
                                            <div className="p-4 bg-info/10 rounded-lg border border-info/20">
                                                <p className="text-sm font-semibold text-info mb-2">ℹ ETFs Sectoriales</p>
                                                <p className="text-xs text-text-secondary">XLK, XLF, XLE, XLV, XLP, XLI, XLY</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
