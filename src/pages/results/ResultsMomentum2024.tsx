...
export const ResultsMomentum2024 = () => {
    ...
    const loadResults = async () => {
        try {
            setIsLoading(true);
            const docRef = doc(db, 'simulations-momentum', '2024');
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-text-secondary">
                            Simulación histórica de la estrategia Momentum en 2024
                        </p>
                    </div>
                ...
                {results ? (
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-border p-12 text-center">
                        ...
                        <p className="text-text-secondary mb-6">
                            Ejecuta la simulación para ver el rendimiento de la estrategia Momentum en 2024
                        </p>
                    </div>
                )}
            </div>
