...
export const ResultsBreakout2023 = () => {
    ...
    const loadResults = async () => {
        try {
            setIsLoading(true);
            const docRef = doc(db, 'simulations-Breakout', '2023');
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-text-secondary">
                            SimulaciÃ³n histÃ³rica de la estrategia Breakout en 2023 (YTD: Ene 1 - Dic 14)
                        </p>
                    </div>
                ...
                {results ? (
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-border p-12 text-center">
                        ...
                        <p className="text-text-secondary mb-6">
                            Ejecuta la simulaciÃ³n para ver el rendimiento de la estrategia Breakout en 2023
                        </p>
                    </div>
                )}
            </div>
