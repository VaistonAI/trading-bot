...
export const ResultsPairs2023 = () => {
    ...
    const loadResults = async () => {
        try {
            setIsLoading(true);
            const docRef = doc(db, 'simulations-Pairs', '2023');
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        <h1 className="text-3xl font-bold text-text-primary mb-2">
                            R Pairs Trading 2023
                        </h1>
                        <p className="text-text-secondary">
                            SimulaciÃ³n histÃ³rica de la estrategia Pairs Trading en 2023 (YTD: Ene 1 - Dic 14)
                        </p>
                    </div>
                ...
                {results ? (
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-border p-12 text-center">
                        ...
                        <p className="text-text-secondary mb-6">
                            Ejecuta la simulaciÃ³n para ver el rendimiento de la estrategia Pairs Trading en 2023
                        </p>
                    </div>
                )}
            </div>
