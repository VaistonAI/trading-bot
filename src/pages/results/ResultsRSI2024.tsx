...
export const ResultsRSI2024 = () => {
    ...
    const loadResults = async () => {
        try {
            setIsLoading(true);
            const docRef = doc(db, 'simulations-RSI', '2024');
                ...
                <div className="mb-6 flex items-center justify-between">
                    <div>
                        ...
                        <p className="text-text-secondary">
                            SimulaciÃ³n histÃ³rica de la estrategia RSI en 2024 (YTD: Ene 1 - Dic 14)
                        </p>
                    </div>
                ...
                {results ? (
                    ...
                    <div className="bg-white rounded-lg shadow-sm border border-border p-12 text-center">
                        ...
                        <p className="text-text-secondary mb-6">
                            Ejecuta la simulaciÃ³n para ver el rendimiento de la estrategia RSI en 2024
                        </p>
                    </div>
                )}
            </div>
