                    ...
                    <div className="relative z-10 h-full flex flex-col justify-between p-6 lg:p-8">
                        ...
                        <div className="space-y-2.5 animate-slide-up">
                            ...
                            <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/20 shadow-xl hover:bg-white/15 transition-colors">
                                ...
                                <p className="text-xs text-white/80">✓ Totalmente personalizado • Soporte 24/7</p>
                            </div>

                            {/* Compra de Código */}
                            <div className="bg-white/10 backdrop-blur-md rounded-xl p-3 border border-white/20 shadow-xl hover:bg-white/15 transition-colors">
                                <p className="text-sm font-semibold mb-0.5">💎 Bot de Trading Personalizado</p>
                                <p className="text-xs text-white/80">✓ Estrategias bajo cotización</p>
                            </div>
